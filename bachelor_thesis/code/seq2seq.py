...
from models.attn import Encoder, AttnDecoder
...
def trainIters(encoder, decoder, input_lang, output_lang, pairs, max_len, n_iters, print_every=1000, plot_every=100, learning_rate=0.001):
    start = time.time()
    plot_losses = []
...
def evaluateRandomly(encoder, decoder, max_len, n=10):
    for i in range(n):
        ...
        print('>', pair[0])
        print('=', pair[1])
        output_words, attentions = evaluate(encoder, decoder, pair[0], max_len)
...
if __name__ == '__main__':
    ...
    evaluateRandomly(encoder, decoder, max_len)
